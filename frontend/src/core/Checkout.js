...
const Checkout = ({products, setRun = f => f, run = undefined}) => { 
	...
	const [data, setData] = useState({
		loading: false, success: false, clientToken: null, error: '', instance: {}, address: ''
	});
			...
			{data.clientToken !== null && products.length > 0 ? (
				<div>
					<div className="form-group mb-3">
						...
						<textarea onChange={handleAddress}  value={data.address} className="form-control" 
						placeholder="Type your delivery address here" />
					</div>
					<DropIn options={{authorization: data.clientToken, paypal:{flow:'vault'} }} 
